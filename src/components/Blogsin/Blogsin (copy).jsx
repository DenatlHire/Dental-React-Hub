                     ...
                     {this.state.items.map(item => (
                        <div className="col-12 col-md-6 col-lg-4 d-flex mb-5" key={item.id} data-aos="fade-up" data-aos-delay="200">
                           <div className="card shadow-light-lg mb-6 mb-md-0 lift lift-lg">
                              ...
                              <Link className="card-body" to={`/blogdetail/${item.slug}`}>
                                 <h3 className="mb-1 fw-bold mb-3" title={item.title} at={item.title}>
                                    {
                                       (item.title)
                              ...
                              <Link className="card-meta" to={`/blogdetail/${item.slug}`}>
                                 <hr className="card-meta-divider" />
                                 <p className="h6 w-100 text-uppercase text-center text-muted mb-0 ms-auto">
