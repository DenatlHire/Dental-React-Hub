...
function PositionSlide({
  ...
  const validationSchema = yup.object().shape({
		designation_id: yup.string().required("Please Select a Type")
	});
  ...
  return (
				...
				<div className="item_form">
					<form onSubmit={handleSubmit(handleSubmitForm)}>
						<div className="item_form_wrap">
							<h2 className="form_title">What Position are You Looking to Fill? </h2>
      ...
      />
           ...
           <div className="slider_in_percent" style={{width: "55%"}}></div>
         </div>
          </div>
        </div>
